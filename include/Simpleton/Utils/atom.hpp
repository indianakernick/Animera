...
namespace Utils {
  ...
  namespace Literals {
    // @TODO
    // template <char... Chars>
    // constexpr Atom operator""_atom() noexcept
    // better error messages.
    // maybe do verification with char... then convert that to a string
    // and pass it to toAtom.
    // or perform the whole operation with char...
